    ...
    return (
        <>
            ...
            <View style={styles.container}>
                ...
                <View>
                    <Text style={styles.heading}>Doctor Sign In</Text>
                    ...
                    <TouchableOpacity style={styles.button} onPress={() => { navigation.navigate("DoctorDashboard") }}><Text style={styles.buttontext}>Sign In</Text>
                        <MaterialCommunityIcons name="arrow-right-circle" size={25} color={"white"} style={{ marginRight: 5 }} />
                    </TouchableOpacity>
                </View>
                <Text style={styles.footer}>Don't have an account? <Text style={{ color: "#53666c", fontWeight: "bold" }} onPress={() => { navigation.navigate("DoctorRegistration") }}>Create an account</Text></Text>
